/*Да се дефинира клас BankAccount, който да има следните член данни и методи: Клас BankAccount Eдин акаунт има следните атрибути: 
name - име на клиент (в динамичната памет) 
accountNumb - номер на банкова сметка (в динамичната памет) 
balance - баланс на сметката 
и следните методи: конструктор - по подразбиране и с 3 параметъра copy-конструктор operator= деструктор 
...
Да се дефинира клас Bank, който да има следните член данни и методи: Клас Bank Банката да да има следните член данни: 
accounts - в масив от BankAccount (максимален размер 100) 
size - брой на акаунтите в банката 
и следните методи: голямата четворка 
void addAccount(BankAccount) - добавяне на нов акаунт в банката (бонус точки за реализаране чрез operator+= void deleteAccount(char*) 
- изтриване на акаунт по зададен номер на банкова сметка 
...
int main()
{
	...
	char name1[100] = "Ralitsa";
	char acNUm[100] = "BG 990808";

	char name2[100] = "Gosho";
	char acNum[100] = "BG 000 No money";
